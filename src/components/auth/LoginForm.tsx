...
export default function LoginForm() {
    ...
    async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
        ...
        try {
            // Normalize credentials before sending them so the API receives a
            // stable payload even if the user types spaces or uppercase letters.
            ...
            // The dashboard reads these values immediately on load while the
            // protected API still trusts the access token for real auth checks.
